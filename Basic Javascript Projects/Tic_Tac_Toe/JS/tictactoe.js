...
function placeXorO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            activePlayer = 'O';
            // If active player is anything but 'X'
        }
        else {
    ...
    function computersTurn() {
        ...
        let success = false;
        // This variable stores a random number ranging from 0-8.
        let pickASquare;
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        x = x1,
        // This variable stores temporary y axis data we update in our aniamtion loop.
        y = y1;
    ...
    function animateLineDrawing() {
        ...
        c.beginPath();
        // This method moves us to a starting point in our own line.
        c.moveTo(x1, y1);
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) { y += 10; }
            // This condition is similar to the one above but is necessary for the 6, 4, 2 win condition.
